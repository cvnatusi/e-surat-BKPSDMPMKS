    ...
    <div class="" style="margin-top:0.5em">
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse;table-layout: fixed; width: 100%;">
          <tbody>
              ...
              <td width="65%"style="vertical-align:top"height="3%" colspan="2">
                <table border="0" width="100%">
                  <tr>
                    ...
                    <td style="text-align: right !important;">{{Carbon\Carbon::parse($data->tanggal_surat)->locale('id')->translatedFormat(' d F Y')}}</td>
                  </tr>
                </table>
              </td>
            ...
            <tr >
              <td width="65%" style="vertical-align:top"height="8%"colspan="2" rowspan="2">&nbsp;Perihal :&nbsp;{{$data->perihal_surat}}</td>
