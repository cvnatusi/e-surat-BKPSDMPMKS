...
<body>
    ...
    @foreach ($listData as $key => $data)
        ...
        <div class="" style="margin-top:0.5em">
            ...
            <tbody>
                ...
                <td style="vertical-align:top"colspan="3">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right !important;">{{ $data->suratMasukId->no_agenda }}</td>
                    </tr>
                    </table>
                    </td>
                </tr>
                ...
                <td width="65%"style="vertical-align:top"height="3%" colspan="2">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right !important;">{{ $data->suratMasukId->tanggal_surat }}</td>
                    </tr>
                    </table>
                </td>
                <td width="10%"style="vertical-align:top"rowspan="4">&nbsp;Sifat : </td>
                <td width="28%">&nbsp; a. Rahasia</td>
                <td width="10%" height="30px" style="text-align: center !important;">
                    @if ($data->suratMasukId->sifat->nama_sifat_surat == 'Rahasia')
                    {{-- <img src="{{$check}}" style="margin-left:25px" width="18px" alt=""> --}}
                    <img src="{{asset('assets/images/check.png')}}" style="" width="18px" alt="">
                    @endif
                </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="65%" style="vertical-align:top"height="3%" colspan="2" rowspan="2">
                        <table border="0" width="100%">
                        <tr>
                            <td style="text-align: left !important;">Perihal :</td>
                            <td style="text-align: right !important;">{{ $data->suratMasukId->perihal_surat }}</td>
                        </tr>
                        </table>
                    </td>
                    ...
                    <td width="10%" height="30px" style="text-align: center !important;">
                        @if ($data->suratMasukId->sifat->nama_sifat_surat == 'Umum')
                        {{-- <img src="{{$check}}" style="margin-left:25px" width="18px" alt=""> --}}
                        <img src="{{asset('assets/images/check.png')}}" style="" width="18px" alt="">
                        @endif
                    </td>
            ...
            <div class="">
            <table cellpadding="0" cellspacing="0" style="border-collapse: collapse;table-layout: fixed; width: 100%; margin-top: 10px;margin-bottom: -10px;">
                <thead>
                <tr>
            ...
            <table  border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse;table-layout: fixed; width: 100%;">
                <tbody>
                <tr>
                    <td width="42%" style="padding-top: 4px;padding-bottom: 4px;">&nbsp;<b>Sekretaris</b></td>
                    <td width="5%">
                        @if ($data->penerima->jabatan == 1)
            ...
            <table cellpadding="0" cellspacing="0" style="border-collapse: collapse;table-layout: fixed; width: 100%;margin-top: 10px;">
                <thead>
                <tr>
                    <td>
                        <img id='barcode'
