<div class="card border-top border-0 border-4 border-primary panel-form">
  <div class="card-body">
    <div class="card-title d-flex align-items-center">
      ...
      <h5 class="mb-0 text-primary">@if($data) Edit @else Tambah @endif Jabatan</h5>
    </div>
    <hr>
    <form class="row g-3 form-save">
      @if(!empty($data))
          <input type="hidden" class="form-control" name="id" value="{{$data->id_mst_jabatan}}">
      @endif
      <div class="col-md-4">
        <label for="singkatan_sifat_surat" class="form-label">Nama Jabatan *)</label>
        <input type="text" class="form-control" name="nama_jabatan" id="nama_jabatan" value="@if($data) {{$data->nama_jabatan}} @endif" placeholder="Nama Jabatan ">
      </div>
      <hr>
      <div class="col-md-12">
