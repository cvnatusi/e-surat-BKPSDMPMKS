...
@section('js')
  ...
  $(function() {
    var table = $('#datagrid').DataTable({
      ...
      {
        data: 'jenis_surat.nama_jenis_surat',
        name: 'jenis_surat.nama_jenis_surat',
        render: function(data, type, row) {
          return '<p style="color:black">' + data + '</p>';
        }
      },
  ...
  $('.btn-add').click(function(){
      // $('.preloader').show();
      $('.main-page').hide();
      $.post("{!! route('form-master-surat') !!}").done(function(data){
  ...
  function editForm(id) {
    $('.main-page').hide();
      $.post("{!! route('form-master-surat') !!}",{id:id}).done(function(data){
          if(data.status == 'success'){
            $('.other-page').html(data.content).fadeIn();
          } else {
            $('.main-page').show();
   ...
   function deleteForm(id) {
     swal({
       ...
       if (result.value) {
         $.post("{!! route('destroy-master-surat') !!}",{id:id}).done(function(data){
