            ...
            @foreach ($data as $key => $value)
              <tr>
                ...
                @if (!empty($value->file_surat_tugas))
                  <td><a href="{{asset('storage/surat-tugas/'.$value->file_surat_tugas)}}" target="_blank" type="button"  class="btn btn-info px-5"><i class="bx bx-cloud-download me-1"></i>Downloads</a></td>
                  @else
