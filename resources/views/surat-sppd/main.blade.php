        ...
        <div class="card-body">
            ...
            <div class="col-md-12" style="margin-bottom: 20px;">
                <div class="row">
                    ...
                    <div class="col-md-8" id="span"></div>
    ...
    var arrSuratId = []
        function showButtonDelete() {
            ...
            if (listCheked.length >= 1) {
                ...
                $('#span').removeClass('col-md-8').addClass('col-md-6');
            } else {
                $('#delete_all').css('display', 'none');
                $('#span').removeClass('col-md-8').addClass('col-md-8');
            }
        }
        ...
        function deleteAll() {
          swal({
            ...
            if (result.value) {
              $.post("{!! route('delete-all-surat-sppd') !!}",{listId: arrSuratId}).done(function(data){
