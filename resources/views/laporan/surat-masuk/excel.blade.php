  ...
  <table id="body_excel" style="table-layout:fixed; width: 100%;border:1px solid black;" >
    <thead>
       <tr>
        ...
        <th style="font-weight:bold;text-align:center;"><b>TANGGAL TERIMA</b></th>
    ...
    <tbody id='panelHasil' style="table-layout:fixed; width: 100%;border:2px solid black;">
        @foreach ($lap as $key => $item)
          <tr>
            ...
            <td style="padding: 5px;" align="center" valign="middle">{{ucwords($item->nomor_surat_masuk)}}</td>
            <td style="padding: 5px;" align="center" valign="middle">{{ucwords($item->tanggal_surat)}}</td>
            <td style="padding: 5px;" align="center" valign="middle">{{ucwords($item->tanggal_terima_surat)}}</td>
            <td style="padding: 5px;" align="center" valign="middle">{{ucwords($item->pengirim->nama_instansi ?? '-')}}</td>
